...
var GameLayer = cc.Layer.extend({
    ...
    onExit : function(){
         if(this.moving_action){
              this.moving_action.release();
              this._super();
         }
         if(this.trapped_action){
              this.trapped_action.release();
              this._super();
         }
    },
    ctor : function () {
...
//        this.blocks.end();
        ...
        var moving_animation = new cc.Animation(moving_frames, 0.2);//cc.Animation.createWithSpriteFrames(moving_frames, 0.2);
        this.moving_action = cc.RepeatForever.create(cc.Animate.create(moving_animation));this.moving_action.retain();
        var trapped_animation = new cc.Animation(trapped_frames, 0.2);//cc.Animation.createWithSpriteFrames(trapped_frames, 0.2);
        this.trapped_action = cc.RepeatForever.create(cc.Animate.create(trapped_animation));this.trapped_action.retain();
...
var GameScene = cc.Scene.extend({
    ...
    onExit : function(){
        ...
        layers.winUI.release();
        layers.loseUI.release();
        layers.shareUI.release();
    }
});
